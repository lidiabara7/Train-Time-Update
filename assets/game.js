...
database.ref().on("child_added", function (childSnapshot) {
  ...
  console.log("MINUTES TILL NEXT TRAIN: " + tMinutesTillNextTrain);

  // Next Train
  var nextTrain = moment().add(tMinutesTillNextTrain, "minutes").format("hh:mm a");
